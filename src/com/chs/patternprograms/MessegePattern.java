...
public class MessegePattern {
	...
	public static void main(String[] args) {
		...
		for(int i=0 ; i<n ; i++) {
			...
			for(int j=0 ; j<n ; j++) {
				if(i==0 && j!=0 && j!=(n-1) || j==0 && i!=0 && i!=(n-1) || i==(n-1) && j!=0 
		...
		for(int i=0 ;i<n ;i++) {
			for(int j=0 ; j<n;j++) {
				if(i==0 || j==n/2 && i!=(n-1) || i==(n-1) && j<n/2 && j!=n/2) {
					System.out.print("* ");
				}
				else {
					System.out.print("  ");
		...
		for(int i=0 ;i<n; i++) {
			...
			System.out.print("  ");
			for(int j=0 ; j<n ; j++) {
				if(i==0 && j!=0 || j==0 && i<n/2 && i!=0 || i==n/2 && j!=n-1 && j!=0 
						|| j==(n-1) && i!=n/2 && i!=1  && i!=2 && i!=3 && i!=8 || i==(n-1)
						&&j<n-1 ) {
					System.out.print("* ");
				}
				else {
